...
!!! warning inline end "BE ADVISED..."
    ...
    As of 10/30/23 we have been unable to test and confirm these steps in a GNS3 lab. 
...
To display the contenets of the current directory, use the `dir` command:
...
[*Reference*](https://www.dell.com/support/manuals/en-us/dell-emc-os-9/s4048-on-9.14.2.4-config/configuration-file-management?guid=guid-ee703c5d-ff2c-4e01-8dcf-e2a7e49eb69b&lang=en-us)
...
[*Reference 1*](https://www.dell.com/support/manuals/en-us/dell-emc-os-9/s4048-on-9.14.2.4-config/configuration-file-management?guid=guid-ee703c5d-ff2c-4e01-8dcf-e2a7e49eb69b&lang=en-us)
