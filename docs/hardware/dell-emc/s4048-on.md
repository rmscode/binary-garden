...
DellEMC(conf)# management route 0.0.0.0/0 10.1.1.254 #(5)
```
...
5. This is the nexthop - typically your gateway.
...
!!! note
    ...
    `clock set` did not work when we tested for whatever reason despite that being whats listed in the Dell docs. We need to find the correct commdn...maybe we have a different version.
