...
!!! info "Port channel 1000 and VLAN 4094 reservations" 
    ...
    Upon successful VLT-peer formation, the switches automatically assign a non-configurable *port-channel 1000* interface consisting of our VLTi interfaces. *VLAN 4094* is also automatically assigned VLTi. Each are reserved for internal VLT communication.
