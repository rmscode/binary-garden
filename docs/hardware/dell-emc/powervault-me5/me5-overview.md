...
### Controller enclosure <small>(4-port SAS shown)</small> { data-toc-label="Controller enclosure" }
...
### Controller module <small>(4-port SAS shown)</small> { data-toc-label="Controller module" }
