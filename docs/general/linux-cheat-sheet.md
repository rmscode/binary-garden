...
A collection of commonly used commands/tasks in various Linuz operating systems. If the Linux ditro is not specifically mentioned, its safe to assume the command is universal.
